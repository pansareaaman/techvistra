...
const ServicesCards = () => {
  return (
    ...
    <div className="bg-[#0d0c1d] z-10 relative -mt-20 mb-11 text-white pb-10  flex gap-6  mx-auto">
      <img className="w-52 h-5/6" src="/assets/LeftBox.png" alt="" />
      {services.map((service, index) => (
        <div key={index} className="bg-[#120819] p-2 rounded-lg shadow-lg hover:shadow-[#8c8ccd] text-center border w-2/6 "> 
      ...
      <img className="w-52 h-5/6" src="/assets/RightBox.png" alt="" />
    </div>
  );
};
